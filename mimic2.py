...
if __name__ == '__main__':
    ...
    dim_c, dim_h, dim_N, dt = 10, 10, 12, 0.05
    ...
    A_matrix = Variable(0.01*torch.ones((1, 1)), requires_grad= True)
    #初始化A-matrix
    ...
    tsave, trace, lmbda, gtid, tsne, loss, mete = forward_pass(func, torch.cat((c0, h0), dim=-1), tspan, dt, [[]]*5, args.evnt_align,A_matrix)
    visualize('graph_result2', tsave, trace, lmbda, None, None, None, None, tsne, range(5), it, appendix="simulate")